<?php
// add.php for index.php in /var/www/html/my_streaming
//
...
<article>
    ...
    <form method="post" action="add.php">
        ...
        <input type="text" placeholder="Duree du film" name="duree">
        ...
        if (isset($_POST['title']))
        {
            ...
            {
                echo '<p>' . "La durée  n'est pas correcte : " . '</p>';
                $erreur = 1;
            }
            ...
            if ($erreur == 0)
            {
                $add = $co->prepare("INSERT INTO Films (Titre, Realisateur, Annee, Image, Categorie, Duree, Synopsis) VALUES 
(
'$title',
'$realisateur',
'$annee',
